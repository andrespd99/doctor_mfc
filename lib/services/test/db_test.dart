...
class DBTest {
  ...
  DBTest() {
    systemsMap.forEach((systemMap) =>
        systems.add(System.fromMap(id: systemMap['id'], data: systemMap)));
  }
                  ...
                  "solutions": [
                    {
                      ...
                      "links": {
                        "Manually move shuttle":
                            "https://www.linktomanuallymoveshuttle.com"
                      }
                    }
                  ]
                },
                  ...
                  "solutions": [
                    {
                      ...
                      "links": {
                        "How to restart Open Shuttle":
                            "https://www.linktorestartopenshuttle.com"
                      }
                    },
                    {
                      "id": "${uuid.v4()}",
